...
func _shoot() -> void:
	...
	# _hold_distance() deliberately closes Rattles to well inside that
	# muzzle offset for its bone-ring melee mechanic.
...
func die() -> void:
	...
	GameManager.record_kill("Rattles", _last_damage_weapon)
