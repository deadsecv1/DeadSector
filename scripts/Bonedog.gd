...
# One of Rattles' three bonedogs. Same core AI as a regular enemy, but
...
func _physics_process(delta: float) -> void:
	...
	if global_position.distance_to(leash_point) > leash_radius:
