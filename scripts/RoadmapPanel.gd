...
const ROADMAP := [
	...
	{"section": SECTION_UPCOMING, "date": "Aug 13", "title": "Deeper Inventory Overhaul", "desc": "Items with real footprints in the grid - a sniper takes more room than a bandage - plus specialized cases (medical, gun, armor, key) with their own sub-grids.", "icon": "gear"},
